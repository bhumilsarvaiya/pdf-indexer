onmessage = async function (msg) {
  ...
  let lines = msg.data.lines
  page_no = msg.data.page
  const nlp = require('compromise')
  const _ = require('lodash')

  this.constructor.prototype.refine = async function (data, page, type, extracted, bool) {
  ...
  sort(pageData)
  this.postMessage({result: pageData})
}
